"""
fix_api.py — Rewrites dashboard/app.py with working AI labels.
...
Path("dashboard/app.py").write_text(content, encoding="utf-8")
print("Fixed: dashboard/app.py — AI labels will now show on dashboard")
