...
A project that combines **honeypot deception technology** with **AI-based attack classification** and a **real-time web dashboard**. The system captures, classifies, and visualises network attacks across four simulated services.
